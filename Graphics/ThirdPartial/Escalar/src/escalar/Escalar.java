...
public final class Escalar extends JFrame{
    public class Draw{
        public Draw(){ }
    ...
    float scale = 1.5f;
    float xLim = scale * (coord[2][0] + tx), yLim = coord[2][1] + ty, zLim = coord[2][2] + tz;
    ...
    public static void main(String[] args) { new Escalar(); }
    ...
    public void drawCube(){
        while(coord[2][0] < xLim){
            ...
            coord[1][0] += 0.4;
            coord[2][0] += 0.4; coord[2][1] += 0.4;
                                coord[3][1] += 0.4;
            
                                coord[4][1] += 0.4; coord[4][2] += 0.1;
            coord[5][0] += 0.4; coord[5][1] += 0.4; coord[5][2] += 0.1;
            coord[6][0] += 0.4;                     coord[6][2] += 0.1;
                                                    coord[7][2] += 0.1;
    ...
    public void putPixel(int x, int y, Color c, Graphics g){
        ...
        g.drawImage(buffer, x+32, y-10, this);
    }
}
