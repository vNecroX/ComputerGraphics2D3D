...
public final class Escalar extends JFrame implements Runnable{
    ...
    int pOneX = 10; int pOneY = 10;             
    int pTwoX = 30; int pTwoY = 10;
    int pThreeX = 30; int pThreeY = 30;
    int pFourX = 10; int pFourY = 30;
